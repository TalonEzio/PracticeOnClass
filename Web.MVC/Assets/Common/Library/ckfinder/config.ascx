...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "Vũ Thế Mạnh";
        LicenseKey = "RL1FFSQEG6FPEG6DKSG9FEFQHGJXWETE";
        ...
        var type = ResourceType.Add("Images");
        type.Url = BaseUrl + "Images/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "Images/";
        type.MaxSize = 0;
        type.AllowedExtensions = new[] { "bmp", "gif", "jpeg", "jpg", "png", "ico" };
        ...
        type.DeniedExtensions = new[] { "html", "css", "js", "cs" };
    }
